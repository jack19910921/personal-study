...
```mermaid
graph TD
    User[用户一句话 prompt] --> Planner[Planner Agent<br/>扩展为完整产品 spec]
    Planner --> Spec[16 feature spec<br/>+ 视觉设计语言]
    Spec --> Contract[Sprint Contract<br/>Generator + Evaluator 协商 done 标准]
