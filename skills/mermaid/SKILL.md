...
使用本 skill：
- 用户明确要求"画个 Mermaid 图"或"生成流程图/架构图/时序图"
- 其他 skill（如 paper-reading、source-code-reading）需要生成架构图或流程图
- 用户提供文章、方案、PRD、会议纪要或口头描述，希望整理成可视化图表
...
- 在 `flowchart` 中，如果节点文本里包含 `/plan-ceo-review` 这类带斜杠的字符串，要写成 `E1["/plan-ceo-review"<br/>CEO视角]`，否则容易触发语法错误
